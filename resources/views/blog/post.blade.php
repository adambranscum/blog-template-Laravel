   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
        <ul class="navbar-nav">
          ...
          <article class="blog-post mt-2 shadow bg-light p-4 mb-5">
            <div>
                @if($errors->any())
                <ul>
            ...
            <img src="http://127.0.0.1:8000/storage/headers/{{$post->post_header}}"  class="img-fluid rounded-start w-100 mb-3 " alt="{{$post->post_title}}">
            <h2 class="display-5 link-body-emphasis mb-1 fw-bolder text-cream">{{$post->post_title}}</h2>
            <p class="blog-post-meta text-muted">{{$post->created_at}} by <a class="text-decoration-none text-cream" href="#">{{$post->post_author}}</a></p>

            <p class="text-cream">{!!html_entity_decode($post->post)!!}</p>
