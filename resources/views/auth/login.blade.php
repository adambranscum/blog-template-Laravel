...
<link href="https://fonts.cdnfonts.com/css/montserrat" rel="stylesheet">  
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label class="text-dark fw-bolder" for="email" :value="__('Email')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label class="text-dark fw-bolder" for="password" :value="__('Password')" />
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center text-dark fw-bolder">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ml-3 bg-form-blue shadow text-white">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
